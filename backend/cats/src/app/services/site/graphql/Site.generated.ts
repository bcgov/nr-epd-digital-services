...
export type FindSiteBySiteIdForServiceQuery = {
  __typename?: 'Query';
...
export function getSdk(
  ...
  return {
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FindSiteBySiteIdLoggedInUserQuery>({
            document: FindSiteBySiteIdLoggedInUserDocument,
            variables,
    ...
    findSiteBySiteIdForService(
      variables: FindSiteBySiteIdForServiceQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit['signal'],
    ): Promise<FindSiteBySiteIdForServiceQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FindSiteBySiteIdForServiceQuery>({
            document: FindSiteBySiteIdForServiceDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),

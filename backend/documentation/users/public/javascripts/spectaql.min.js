...
function scrollSpy() {
  ...
  function t() {
    ...
    Array.prototype.forEach.call(e, function (e) {
      s.push({ id: e.id, top: e.offsetTop });
    });
  }
  var n = debounce(function () {
    ...
    o = debounce(function () {
      var e,
        ...
        o,
        c = (function (e) {
          for (var t = e + l, n = 0; n < s.length; n++) {
            var o = s[n + 1];
            if (t >= s[n].top && (!o || t < o.top)) return n;
          }
          return -1;
      ...
      c !== d &&
        ...
        (t = o(
          (c = c ? document.querySelector("#nav a[href*=" + c.id + "]") : null),
        )),
        (n = (o = o(e)) !== t),
        o && n && o.classList.remove(i),
        t && n && t.classList.add(i),
        c &&
          (c.classList.add(r),
          c.scrollIntoViewIfNeeded
            ? c.scrollIntoViewIfNeeded()
            : !c.scrollIntoView ||
              (0 <= (o = (o = c).getBoundingClientRect()).top &&
                0 <= o.left &&
                o.bottom <=
                  (window.innerHeight ||
              ...
              c.scrollIntoView({ block: "center", inline: "start" })),
        e) &&

...
export class masterScript1738706351387 implements MigrationInterface {
    name = 'masterScript1738706351387'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "epd_cats_2"."external_user" ADD CONSTRAINT "FK_3a190f9e8b4038afe9ad21c87b6" FOREIGN KEY ("organization_type_id") REFERENCES "epd_cats_2"."organization_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "epd_cats_2"."external_user" ADD CONSTRAINT "FK_fba6990ebb6be02291805127a69" FOREIGN KEY ("region_id") REFERENCES "epd_cats_2"."region"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "epd_cats_2"."external_user" DROP CONSTRAINT "FK_fba6990ebb6be02291805127a69"`);
        await queryRunner.query(`ALTER TABLE "epd_cats_2"."external_user" DROP CONSTRAINT "FK_3a190f9e8b4038afe9ad21c87b6"`);
        ...
        await queryRunner.query(`DROP INDEX "epd_cats_2"."IDX_externaluser_user_id"`);
        await queryRunner.query(`DROP TABLE "epd_cats_2"."external_user"`);
        await queryRunner.query(`DROP TABLE "epd_cats_2"."region"`);
        await queryRunner.query(`DROP TABLE "epd_cats_2"."organization_type"`);

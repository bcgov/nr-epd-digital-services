...
describe('currentUpload', () => {
  ...
  it.each([
    ...
    [
      ...
      false,
      539,
      "attachment; filename=foo.txt; filename*=UTF-8''f%C3%B6o.txt",
      'text/plain',
    ],
    [
      1,
      ...
      false,
      539,
      "attachment; filename*=UTF-8''f%C3%B6o.txt; filename=foo.txt",
      'text/plain',
    ],
    ...
    'should call next %i times with currentUpload %j given strict %j, length %j, disposition %j and type %j',
    (nextCount, current, strict, length, disposition, type) => {

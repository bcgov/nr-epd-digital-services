...
exports.up = function (knex) {
  return (
    Promise.resolve()
      ...
      .then(() =>
        knex.schema.withSchema('queue').createTable('object_queue', (table) => {
          table.specificType(
            'id',
          ...
          table.unique(['bucketId', 'path'], {
            predicate: knex.whereNotNull('bucketId'),
          });
...
exports.down = function (knex) {
  return (
    Promise.resolve()
      ...
      .then(() =>
        knex.schema.withSchema('queue').dropTableIfExists('object_queue'),
      )

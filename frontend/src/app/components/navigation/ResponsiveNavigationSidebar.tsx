        ...
        <>
            <Row className="d-md-none">
                <Dropdown className='my-4'>
                    <Dropdown.Toggle  variant="secondary" id='dropdown-toggle' className="d-block d-md-none w-100">Site Options<FaBars id='toggle-icon'/></Dropdown.Toggle>
                    <div>
            ...
            <Row id="nav-panel-row" className="d-none d-sm-none d-md-block border mt-2 navPanelBoxShadow" >

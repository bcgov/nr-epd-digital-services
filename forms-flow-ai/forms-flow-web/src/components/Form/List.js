...
const List = React.memo((props) => {
  ...
  const getReactDashboardURL = () =>{
    if(window.location.href.includes("localhost")){
        return "http://localhost:4000/dashboard";
    }else if(window.location.href.includes("devops.gov.bc")){
        return "https://epd-frontend-dev.apps.silver.devops.gov.bc.ca/dashboard";
    }else{

...
rsync -av /local_src/ /forms-flow-nav/app/ --exclude node_modules
...
nodemon -L --watch /local_src --delay 1 --ext js,jsx,scss,css,json --ignore node_modules --exec "rsync -av /local_src/ /forms-flow-nav/app/ --exclude node_modules" &

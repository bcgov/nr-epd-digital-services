import { FormFieldType, IFormField } from "@cats/components/input-controls/IFormField";
...
export const GetInvoiceConfig = (viewMode: UserMode, isDisabled: boolean, 
    ...
    const customInvoiceRecipient =  <DropdownSearchInput
                        ...
                        isLoading={!recipient.loading ? RequestStatus.idle : RequestStatus.loading}
                        validation={
                            {
                                required: true,
                        ...
                        />;
    const customInvoiceRecProfileLink = <Link
    ...
    const applicationDetailsForm: IFormField[][] =[ 
        [invoiceForm.applicationId, invoiceForm.siteAddress, invoiceForm.applicationType]
    ];
    ...
    const invoiceDetailsForm: IFormField[][] = [
        ...
        [invoiceForm.issueDate, invoiceForm.dueDate,invoiceForm.taxExempt, invoiceForm.pstExempt],
    ...
    const invoiceItemsTableConfigs:TableColumn[] = [
        ...
        },
        {
            ...
            displayType: {
                ...
                graphQLPropertyName: 'quantity',
                value: '',
                customInputTextCss: 'custom-invoice-items-txt d-flex justify-content-end',

...
const FORM_BACKEND_API: string = import.meta.env.VITE_FORM_BACKEND_API || window._env_.VITE_FORM_BACKEND_API;
const FORM_FLOW_API: string = import.meta.env.VITE_FORM_FLOW_API || window._env_.VITE_FORM_FLOW_API;

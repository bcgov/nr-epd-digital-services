  ...
  const participantColumnInternal: TableColumn[] = [
    {
      ...
      displayType: {
        ...
        customLabelCss:
          'custom-participant-lbl-text common-text-style common-icon-orientation',
        customIcon: <TickIcon />,
        customInputTextCss:
          'custom-participant-input-text common-text-style common-icon-orientation',
        tableMode: true,
      },
    },
    {
      ...
      displayType: {
        ...
        value: '',
        colSize: 'col-lg-6 col-md-6 col-sm-12',
        customLabelCss: 'custom-participant-lbl-text common-text-style',
        customInputTextCss: 'custom-participant-input-text common-text-style',
        tableMode: true,
      },
      dynamicColumn: true,
    },

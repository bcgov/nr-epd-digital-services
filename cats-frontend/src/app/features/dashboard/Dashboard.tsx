...
const Dashboard = () => {
  ...
  const {data, loading: recentViewedLoading} = useGetRecentViewedApplicationsQuery({
  ...
  return (
    <PageContainer role="Dashboard">
      ...
      <Button className='dashboard-btn justify-content-center' variant="primary" size='medium' onClick={() => {}}>
